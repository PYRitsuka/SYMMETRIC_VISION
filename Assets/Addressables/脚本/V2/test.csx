...
Tachie.CoveringIn( name = "Kokomi", direction = "left", time = 0.5,); //切换图片并向右擦入
...
Picture.SpeedLineOn();
Frame.BMIOn(color = "pink",duration=1.0,);
Script.Text(dialogue = "speed line on: 2035年9月8日（星期六）凌晨，0时22分。", speed = 30,);
WaitForClick();


Frame.BMIOn(color = "blue",duration=1.0,);
Script.Text(dialogue = "2035年9月8日（星期六）凌晨，0时22分。", speed = 30,);
WaitForClick();

Frame.BMIOn(color = "gray",duration=1.0,);
Script.Text(dialogue = "2035年9月8日（星期六）凌晨，0时22分。", speed = 30,);
WaitForClick();

Frame.BMIOff(color = "pink",duration=1.0,);
Script.Text(dialogue = "2035年9月8日（星期六）凌晨，0时22分。", speed = 30,);
WaitForClick();

Frame.BMIOff(color = "blue",duration=1.0,);
Script.Text(dialogue = "2035年9月8日（星期六）凌晨，0时22分。", speed = 30,);
WaitForClick();

Frame.BMIOff(color = "gray",duration=1.0,);
Script.Text(dialogue = "2035年9月8日（星期六）凌晨，0时22分。", speed = 30,);
WaitForClick();


Tachie.CoveringOut( name = "Kokomi", direction = "left", time = 0.5,); //切换图片并向右擦入
Script.Text(dialogue = "2035年9月8日（星期六）凌晨，0时22分。", speed = 30,);
WaitForClick();
Script.Text(dialogue = "2035年9月8日（星期六）凌晨，0时22分。", speed = 30,);
WaitForClick();
...
Text.Clear();
//五十岚心弥登场特写
Picture.Alpha(name = "Move", alpha_began = 0, alpha_ended = 1, time = 1,);
Picture.Blur(name = "Move",radius=1.0,duration=5);
WaitForClick();
Picture.Blur(name = "Move",radius=0.0,duration=5);
WaitForClick();
